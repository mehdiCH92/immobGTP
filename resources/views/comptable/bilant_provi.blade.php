...
<body style="background-color:  #f8f9f9 ;color: #ffffff;text-decoration-color:#ffffff; font-family: Palatino;" >
    ...
    <div class="container-fluid" >
        <div class="container text-center">
            ...
            <strong style="color: #000;margin-top:10px;">dete de bilant {{date('d F Y')}}</strong>
...
<button type="button" class="btn btn-info float-right" onclick="imprimer_page()" id="bt">imprimer</button>
</div>
