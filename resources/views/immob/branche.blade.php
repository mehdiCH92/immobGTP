...
<div class="container text-center">
  <h2><span class="badge badge-secondary text-center">Ajouter une Branche 'Unité' </span></h2>
</div>
...
<table class="table table-striped" style="border-style:solid;border-width: 2px; background-color: #fff;color: #000000;margin-bottom: 0px; ">
  <tbody>
    <tr style="text-align: center;">
      <th>Ajouter une branche </th>
      <td scope="col"></td>
      <th> Nome de l'unité </th>
   <td scope="col"><input type="text" name="branche" class="form-control" placeholder="GTP Oran" aria-label="Branche" aria-describedby="basic-addon1"></td>
    </tr>
  </tbody>
</table>
</form>
...
<table class="table table-bordered table-striped " style="margin-top: 80px; margin-bottom: 0px; color:#000;background-color: #fff;">
  <thead>
    <tr class="text-center border border-dark text-dark bg-secondary">
       <th scope="col" >ID</th>
      <th style="width:800px;"  >Branche (unité)</th>
