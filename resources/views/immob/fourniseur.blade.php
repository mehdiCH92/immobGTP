...
@section('content')
<form action="{{url('fourniseur_st')}}" method="POST">
{{csrf_field()}}
...
<table class="table table-striped" style="border-style:solid;border-width: 2px; background-color: #fff;color: #000000;margin-bottom: 0px; ">
  <tbody>
    <tr style="text-align: center;">
      <th>Ajouter un fourniseur </th>
      <th> nome de fourniseur </th>
   <td scope="col"><input type="text" name="fourniseur" class="form-control" placeholder="Fourniseur GTP" aria-label="Branche" aria-describedby="basic-addon1"></td>
    </tr>
  </tbody>
</table>
...
<table class="table table-bordered table-striped " style="margin-top: 80px; margin-bottom: 0px; color:#000;background-color: #fff;">
  <thead>
    <tr class="text-center border border-dark text-dark bg-secondary">
       <th scope="col" >ID</th>
      <th style="width:800px;"  >Fournisseur</th>
